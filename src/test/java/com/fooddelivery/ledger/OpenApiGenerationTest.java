...
public class OpenApiGenerationTest {
    ...
    private com.fooddelivery.ledger.service.DoubleEntryLedgerService doubleEntryLedgerService;
    ...
    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.ledger.reconciliation.ReconciliationBreakRepository reconciliationBreakRepository;

    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.ledger.reconciliation.ReconciliationService reconciliationService;
    ...
    // TimeConfig: the platform Clock, which the scanned AccountingCalendar needs (the app gets it by scanning com.fooddelivery.common).
    @org.springframework.context.annotation.Import({com.fooddelivery.common.config.OpenApiJsonMediaTypeCustomizer.class, com.fooddelivery.common.config.OpenApiPaginationRequiredCustomizer.class, com.fooddelivery.common.time.TimeConfig.class})
    @org.springframework.context.annotation.ComponentScan(basePackages = {"com.fooddelivery.ledger.controller", "com.fooddelivery.ledger.reconciliation"})
