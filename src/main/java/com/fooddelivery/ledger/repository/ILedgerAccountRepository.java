...
public interface ILedgerAccountRepository extends JpaRepository<LedgerAccount, UUID> {
    ...
    Optional<LedgerAccount> findByOwnerIdAndOwnerTypeForUpdate(@org.springframework.data.repository.query.Param("ownerId") UUID ownerId, @org.springframework.data.repository.query.Param("ownerType") AccountType ownerType);
